...
class LineChartSampleThree extends StatefulWidget {
  final weekDays = ['Sat', 'Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri'];

  final List<double> yValues = [1.3, 1, 1.8, 1.5, 2.2, 1.8, 3];

  @override
  State createState() => _LineChartSampleThreeState();
}

class _LineChartSampleThreeState extends State<LineChartSampleThree> {
  double touchedValue;
