...
class LineChartSampleEight extends StatefulWidget {
  @override
  _LineChartSampleEightState createState() => _LineChartSampleEightState();
}

class _LineChartSampleEightState extends State<LineChartSampleEight> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: AspectRatio(
        aspectRatio: 1,
        child: FutureBuilder<SizedPicture>(
            future: loadSvg(),
