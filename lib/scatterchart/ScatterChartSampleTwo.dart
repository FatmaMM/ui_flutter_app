...
class ScatterChartSampleTwo extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return ScatterChartSampleTwoState();
  }
}

class ScatterChartSampleTwoState extends State<ScatterChartSampleTwo> {
  int touchedIndex;
